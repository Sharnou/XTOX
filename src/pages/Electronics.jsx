...
const SUBS = ["All", "Mobile Phones", "Computers", "Cameras", "Gaming", "TV & Audio"];
...
export default function Electronics() {
  ...
  const load = async () => {
    setLoading(true);
    const filter = { status: "active", category: "electronics" };
  ...
  return (
    <div className="min-h-screen bg-background font-inter">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-purple-800 text-white py-10 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-2">
            <Smartphone className="w-8 h-8 text-yellow-400" />
            <h1 className="text-3xl font-black">Electronics</h1>
          </div>
          <p className="text-white/70">Phones, laptops, cameras, gaming and more</p>
        </div>
      </div>
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <AdsGrid ads={ads} isLoading={loading} emptyMessage="No electronics listings found." />
      </div>
      <XTOXFooter />
    </div>
  );
